			...
			>
				...
				<View style={{ marginBottom: 20 }}>
					...
					<Text style={{ fontSize: 14, lineHeight: 22, color: "#444" }}>
						...
						{"\n\n"}
						All information, daily tips, and self-care ideas generated by the App's AI features are for general informational and educational purposes only. They are NOT intended to be a substitute for professional advice.
						{"\n\n"}
				...
				<View style={{ marginBottom: 20 }}>
					...
					<Text style={{ fontSize: 14, lineHeight: 22, color: "#444" }}>
						...
						(e.g., Anthropic) to generate general daily tips. These tips are not
