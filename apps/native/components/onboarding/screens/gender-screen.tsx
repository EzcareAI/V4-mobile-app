...
const GENDER_OPTIONS: SingleSelectOption[] = [
	{
		id: "female",
		label: "Female",
		description: "Tailored for women's lifestyle",
		icon: Venus,
		iconColor: "#FF8099",
	},
	{
		id: "male",
		label: "Male",
		description: "Tailored for men's lifestyle",
		icon: Mars,
		iconColor: "#66B3FF",
	},
	{
					...
					<View className="flex-1">
						...
						<View className="mt-8 items-center">
							<View className="relative h-28 w-28 items-center justify-center">
								...
								<View className="absolute inset-0 rounded-[40px] bg-[#28B898]/10" />
								{/* Middle layer */}
								<View className="h-full w-full items-center justify-center rounded-[36px] bg-white shadow-blue-200 shadow-xl">
									...
									<View className="h-20 w-20 items-center justify-center rounded-[28px] bg-blue-50/80">
										<CircleDot color="#28B898" fill="#28B898" size={44} />
									</View>
								</View>
							</View>
						</View>
						...
						<StepHeader
							align="center"
							className="mt-8"
							description="This helps us personalize recommendations for your biology and lifestyle profile."
