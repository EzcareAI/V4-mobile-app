		...
		<View className="flex-1 bg-background">
			...
			>
				<View className="flex-1 px-6 py-8">
					...
					<View className="mt-8 rounded-[32px] bg-white p-6 shadow-blue-100 shadow-sm">
						...
						<View className="flex-row justify-between">
							<View className="flex-1 items-center">
								<Text className="font-bold text-2xl text-[#3EC9B5]">100%</Text>
						...
						>
							...
							>
								<View className="h-16 flex-row items-center justify-center">
									...
									<Text className="ml-3 font-bold text-lg text-muted">
										Don't Allow
									</Text>
								</View>
							</LinearGradient>
					...
					<Text className="mt-6 text-center text-slate-400 text-sm">
