...
export function OverallBlockerScreen() {
	...
	const { overallBlocker, setAnswer, nextStep, scanMode, currentStep } =
		useOnboardingStore();
	...
	const options = [
		{
			...
			desc: "Too busy for lifestyle routines",
		},
		{
			value: "consistency",
			label: "📅 Consistency",
		...
		},
		{
			value: "stress",
			label: "⚡ Stress",
			desc: "Too stressed to focus on lifestyle",
		},
			...
			<View className="flex-1 justify-between px-6 pb-10">
				...
				>
					<View className="flex-1 px-1">
						...
						<StepHeader
							className="mt-8"
							description="What makes it hardest to reach your lifestyle goals?"
