				...
				<View className="flex-1 px-6 py-8">
					...
					<View className="mb-6 items-center">
						<View className="relative">
							...
							{/* Gift Badge */}
							<View className="absolute -right-1 -top-1 h-12 w-12 items-center justify-center rounded-full bg-amber-400 shadow-lg shadow-amber-400/30">
					...
					{/* Header */}
					<Text className="mb-2 text-center font-bold text-[#0d2137] text-3xl">
						Got a referral code?
					</Text>
					<Text className="mb-8 text-center text-base text-slate-500 leading-6">
						Unlock exclusive benefits and bonus features with a friend's
						referral code.
					</Text>
					...
					{/* Submit Button */}
					<ContinueButton isDisabled={referralCode?.length === 0} label={<View className="flex-row items-center">
							<Text className="mr-2 text-2xl">✓</Text>
							<Button.Label className="font-semibold text-base text-slate-500">
								Submit Code
							</Button.Label>
						</View>} onPress={handleFinish} />
