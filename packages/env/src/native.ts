...
const schema = z.object({
	...
	EXPO_PUBLIC_APPTROVE_SECRET_ID_IOS: z.string().optional(),
	EXPO_PUBLIC_APPTROVE_SECRET_KEY_IOS: z.string().optional(),
	EXPO_PUBLIC_APPTROVE_SECRET_ID_ANDROID: z.string().optional(),
	EXPO_PUBLIC_APPTROVE_SECRET_KEY_ANDROID: z.string().optional(),
...
const defaults = {
	...
	EXPO_PUBLIC_APPTROVE_SECRET_ID_IOS: "",
	EXPO_PUBLIC_APPTROVE_SECRET_KEY_IOS: "",
	EXPO_PUBLIC_APPTROVE_SECRET_ID_ANDROID: "",
	EXPO_PUBLIC_APPTROVE_SECRET_KEY_ANDROID: "",
...
export const env = {
	...
	EXPO_PUBLIC_APPTROVE_SECRET_ID_IOS:
		parsed.data?.EXPO_PUBLIC_APPTROVE_SECRET_ID_IOS ??
		defaults.EXPO_PUBLIC_APPTROVE_SECRET_ID_IOS,
	EXPO_PUBLIC_APPTROVE_SECRET_KEY_IOS:
		parsed.data?.EXPO_PUBLIC_APPTROVE_SECRET_KEY_IOS ??
		defaults.EXPO_PUBLIC_APPTROVE_SECRET_KEY_IOS,
	EXPO_PUBLIC_APPTROVE_SECRET_ID_ANDROID:
		parsed.data?.EXPO_PUBLIC_APPTROVE_SECRET_ID_ANDROID ??
		defaults.EXPO_PUBLIC_APPTROVE_SECRET_ID_ANDROID,
	EXPO_PUBLIC_APPTROVE_SECRET_KEY_ANDROID:
		parsed.data?.EXPO_PUBLIC_APPTROVE_SECRET_KEY_ANDROID ??
		defaults.EXPO_PUBLIC_APPTROVE_SECRET_KEY_ANDROID,
	EXPO_PUBLIC_MIXPANEL_TOKEN:
